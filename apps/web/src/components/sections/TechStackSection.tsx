                  ...
                  <div key={tech.id}>
                    {tech.url ? (
                      <Link
                        ...
                        className="flex items-center gap-2 glass px-4 py-2.5 rounded-xl text-sm text-secondary font-medium hover:border-purple-500/30 hover:text-primary hover:-translate-y-0.5 transition-all"
                      >
                        {tech.iconUrl && (
                          <Image
                            src={tech.iconUrl}
